...
def generate_market_advice(alert_info: dict, crop: str, language_hint: str = "Hindi") -> str:
    """
    ...
    if status == "unknown":
        ...
        prompt = (
            ...
            f"the recent average is ₹{avg}, which is {pct}% {direction} average. "
            f"In {language_hint}, write ONE short, plain-spoken sentence (under 25 words) "
